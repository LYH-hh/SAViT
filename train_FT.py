...
def get_args_parser():
    ...
    parser.add_argument('--task', default='./output_dir/SAViT_FT/base/ChildCXR_noCrossAttn_scale/',type=str,
                        help='finetune from checkpoint')
    parser.add_argument('--output_dir', default='./output_dir/SAViT_FT/base/ChildCXR_noCrossAttn_scale',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./output_dir/SAViT_FT/base/ChildCXR_noCrossAttn_scale/',
...
def main(args):
    ...
    model = model_SAViT_FT.__dict__[args.model](
